...
usuario1.hacer_deposito(10000).hacer_deposito(20000).hacer_deposito(30000).mostrar_balance_usuario()
print("Se ralizan Giros...")
usuario1.hacer_retiro(30000).mostrar_balance_usuario()

print("------------------------------")

usuario2.mostrar_balance_usuario()
print("Se reciben Depositos...")
usuario2.hacer_deposito(50000).hacer_deposito(50000).mostrar_balance_usuario()
print("Se ralizan Giros...")
usuario2.hacer_retiro(20000).hacer_retiro(20000).mostrar_balance_usuario()

print("------------------------------")

usuario3.mostrar_balance_usuario()
print("Se reciben Depositos...")
usuario3.hacer_deposito(50000).mostrar_balance_usuario()
print("Se ralizan Giros...")
usuario3.hacer_retiro(20000).hacer_retiro(500).hacer_retiro(15000).mostrar_balance_usuario()
...
usuario1.hacer_transferencia(500, usuario3).mostrar_balance_usuario()
usuario3.mostrar_balance_usuario()